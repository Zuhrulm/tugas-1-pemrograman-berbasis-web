  ...
  "2023005678": {
    ...
    perjalanan: [
      ...
      },
      {
        ...
        keterangan: "Diteruskan ke Bandung"
      },
      {
      ...
      },
      {
        ...
        keterangan: "Selesai Antar (Diterima Agus Pranoto)"
      }
    ]
  }
};
...
function login(email, password) {
  return dataPengguna.find(u =>
    u.email === email && u.password === password
  );
}

// CEK TRACKING
function cekTracking(noResi) {
  return dataTracking[noResi] || null;
}

// AMBIL BAHAN AJAR BERDASARKAN LOKASI
function getBahanAjarByLokasi(kodeLokasi) {
  return dataBahanAjar.filter(item => item.kodeLokasi === kodeLokasi);
}